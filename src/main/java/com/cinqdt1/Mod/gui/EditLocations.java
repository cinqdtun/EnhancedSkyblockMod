...
public class EditLocations extends GuiScreen{
	...
	private GuiFeatureButton ashfangHp;
	...
	public void initGui() {
		...
		try {
			ashfangHp = new GuiFeatureButton(cinqdt1Mod.newModConfig.getInteger("ashfangHp", "position", "x"), cinqdt1Mod.newModConfig.getInteger("ashfangHp", "position", "y"), cinqdt1Mod.newModConfig.getFloat("ashfangHp", "position", "scale"), null, 0,0, ashfangHpText, 0, FeatureButton.ASHFANG_HP);
		...
		ashfangHpResize = new GuiFeatureButtonResizable(ashfangHp, FeatureButton.ASHFANG_HP);
		...
		try {
			...
			if(buttonAction == Action.RESIZE) {
				switch (buttonPerformed) {
					case ASHFANG_HP:
						float ashfangHpScale = ashfangHp.getNewScaleWithX(xMoved);
						if (ashfangHpScale > 0.5f && ashfangHpScale < 6.0f)
							cinqdt1Mod.newModConfig.setFloat("ashfangHp", "position", "scale", ashfangHpScale);
				...
				switch (buttonPerformed) {
					case ASHFANG_HP:
						double xValueAshfangHp = cinqdt1Mod.newModConfig.getDouble("ashfangHp", "position", "x");
						double yValueAshfangHp = cinqdt1Mod.newModConfig.getDouble("ashfangHp", "position", "y");
						cinqdt1Mod.newModConfig.setDouble("ashfangHp", "position", "x", xValueAshfangHp + xMoved);
						cinqdt1Mod.newModConfig.setDouble("ashfangHp", "position", "y", yValueAshfangHp + yMoved);
						cinqdt1Mod.newModConfig.saveConfig();
						break;
					case BAT_FIREWORK:
