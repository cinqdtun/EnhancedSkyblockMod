...
public class ItemUtils {
    private static final ItemStack batFireworkItem = Utils.setIdItem(new ItemStack(Items.fireworks), "BAT_FIREWORK");
    ...
    private static final ItemStack inquiHeadItem = Utils.createTexturedAndSetId("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2FlMjU2YTNjMGQ1NjEwMjA4MDVlZTY2ODE4NGYzZjdmOTc2NGJmYWNjOTU5MzgxZjZlNmFkNDFiNTQ3MGMzZSJ9fX0=", "INQUI_HEAD", "00000000-0000-0000-0000-000000000003");
    ...
    public static ItemStack getBatFireworkTexture(){
        return batFireworkItem;
    }
    ...
    public static ItemStack getInquiHeadTexture(){
        return inquiHeadItem;
    }
