...
public class CustomRenderLivingEntity<T extends EntityLivingBase> extends Event {
    ...
    public CustomRenderLivingEntity(EntityLivingBase entity, Render<T> render, double x, double y, double z){
        this.entity = entity;
        this.render = render;
        this.x = x;
        this.y = y;
